...
rbe_sce <- removeBatchEffect(x=exprs(sce), batch=sce$batch,
                     design=mod)
exprs(sce) <- rbe_sce
...
# pdf('data/DE_combrunAT_spikenorm_filt05_T4vN4_GO20_controlCD69sp2.pdf', height=1.7, width=8)
...
# pdf('data/DE_combrunAT_spikenorm_filt10_G4vN4_GO20_controlCD69sp2.pdf', height=2.8, width=8)
# par(mar=c(4.1,22.1,2.1,2.1), mgp=c(2,1,0))
