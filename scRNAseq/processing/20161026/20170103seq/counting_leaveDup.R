...
## For some reason, sample SLX-12612.i727_i508.HH7K7BBXX.s_4.r_1.bam is failing every time we try to count it. But for some reason when I run up to it and then again past it, it all seems fine. I need to switch to the new cluster...

bad_index <- which(bam.files %in% 'bam/SLX-12612.i727_i508.HH7K7BBXX.s_4.r_1.bam')
